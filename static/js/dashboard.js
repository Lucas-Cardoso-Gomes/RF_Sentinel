    ...
    ui: {
        renderStatus(data) {
            ...
            if (data.next_pass) {
                ...
                elements.nextTime.textContent = startTime.toLocaleString('pt-BR', { timeZone: 'America/Sao_Paulo', hour: '2-digit', minute: '2-digit', second: '2-digit' });
