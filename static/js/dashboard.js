        ...
        renderSignals(signals) {
            ...
            if (!signals || signals.length === 0) {
                ...
                newContent = signals.map(signal => {
                    ...
                    // Converte a string 'YYYY-MM-DD_HH-MM-SS' para um objeto Date válido em ISO 8601
                    const isoTimestamp = signal.timestamp.replace(/_(\d{2})-(\d{2})-(\d{2})/, 'T$1:$2:$3');
